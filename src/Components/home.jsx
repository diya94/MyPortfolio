  ...
  return (
    ...
    >
      <div className="lg:w-3/5 w-full flex flex-col justify-center items-start gap-8">
        <h1 data-aos="zoom-in" className="text-blue-300 lg:text-3xl text-xl font-semibold font-poppins">
        ...
        <a
          ...
          data-aos="zoom-in"
          data-aos-delay="400"
          className="bg-themered hover:bg-white text-white hover:text-themered font-semibold text-lg px-8 py-3 rounded-lg mt-5 font-poppins inline-flex items-center gap-2"
        >
      ...
      <div data-aos="zoom-in" data-aos-delay="400"className="lg:w-2/5 w-full relative">
        ...
        />
        <img src={design} alt="" className='absolute -top-2 -right-6 rounded-full z-10'/> 
      </div>
    </div>
  );
};
